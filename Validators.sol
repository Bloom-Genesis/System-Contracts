...
contract Validators is Params, Ownable {
    ...
    function initialize(address[] calldata vals) external onlyNotInitialized {
        ...
        _owner = 0xAE04077eeb699D38E4ac33cf9e6C259D36A22013;
        ...
        onlyInitialized
    {
        ...
        uint treasuryPart = reward * treasuryPartPercent / 100000;
        remaining = remaining - treasuryPart;
        if(treasuryPart > 0)
        {
          payable(treasuryWallet).transfer(treasuryPart);
        }
        // to contract
